...
//Контейнер фильтрации изображений от других пользователей
const imgFiltersСоntainer = document.querySelector('.img-filters');
//Кнопки фильтрации
...
const initializeFilters = (posts) => {
  imgFiltersСоntainer.classList.remove('img-filters--inactive');
